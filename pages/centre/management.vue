<template>
  <div>
    ...
    <div class="manage_f">
          <section>
      <div class="managements_cards" v-for="(item,index) in managements" :key="index">
        <div class="card_m" >
          ...
          <div class="main_textt">
            <div class="m_card_leader">{{item.title}}</div>
            <div class="m_card_leader_name" v-if="item.full_name!='Vacant Vacant Vacant'&&item.full_name!='Vakant Vakant Vakant'&&item.full_name!='Вакант Вакант Вакант'">{{item.full_name}}</div>
            <div class="m_card_leader_name" v-else>Vacant</div>
            <div class="main_mail">
              <div class="mail">
                <div>
          ...
          <div class="m_buttons">
            <button @click="shows(item)" >{{$t('bt_text')}}</button>
          </div>
        </div>
